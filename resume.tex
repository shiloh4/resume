...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
    \vspace{-5mm}
      \resumeItem{Built and styled five React/TypeScript pages (News, Life, Opinions, Entertainment, Sports) with \textbf{React Router} for routing and \textbf{Axios} for paginated API calls.}
      ...
      \resumeItem{Implemented responsive layouts using \textbf{CSS Grid} and \textbf{Flexbox}, ensuring smooth mobile experience and cross-browser consistency (Chrome, Safari, Firefox).}
    ...
    \resumeSubheading
    {Vertically Integrated Project: Video Game for Power Grids}{\textit{Backend/Systems Developer}}
    {}{}
    \resumeItemListStart
    \vspace{-5mm}
      \resumeItem{Engineered and maintained an Azure-hosted backend with secure \textbf{Gurobi API endpoints}, efficient concurrency control, and thread-safe configuration, ensuring reliable high-performance optimization simulations.}
      \resumeItem{Designed a robust \textbf{Gurobi optimization model} to simulate and optimize power grid flow; implemented cache fallback and lookahead mechanisms to ensure real-time continuity despite network issues (e.g., packet loss, latency).}

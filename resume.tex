...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \vspace{-5mm}
      ...
      \resumeItem{Leveraged Plotly.js for interactive \textbf{data visualization}, displaying agent performance metrics such as \textbf{niceness, forgiveness, retaliatory, troublemaking, and emulative behavior} over multiple simulation rounds.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \vspace{-5mm}
        \resumeItem{Developed and maintained Azure server with a focus on secure Gurobi API endpoints, efficient concurrency handling, and thread-safe configuration, ensuring high-performance and reliable data management for optimization simulations.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
  \vspace{1mm}
    \textbf{Programming Languages/Frameworks}{: \textbf{HTML}, \textbf{CSS}, \textbf{JavaScript}, \textbf{React}, React-Native, Java, \textbf{Python}, C, C\#, SQL, PostgreSQL, SQLite, SenseTalk, LaTeX, Django, Flask API, RISC Assembly} \\
   \vspace{1mm}

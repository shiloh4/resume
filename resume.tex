...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
    \vspace{-5mm}
      \resumeItem{Built \& deployed a new website for Georgia Tech's student-led newspaper; led frontend development in React, utilizing \textbf{Vite} \& \textbf{Tailwind CSS} with the focus of modernizing the site, optimizing the mobile experience \& cross-browser consistency.}
    ...
    \resumeSubheading
    {Vertically Integrated Project: Current Crisis (\href{https://currentcrisis.itch.io/current-crisis}{\underline{currentcrisis.itch.io}})}{\textit{Fullstack/Systems Developer}}
    {}{}
    \resumeItemListStart
    \vspace{-5mm}

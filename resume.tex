...
\section{Classes}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \vspace{1mm}
     \textbf{Courses}{: Introduction to OOP, Data Structures and Algorithms, Computer Organization and Programming, Design and Analysis of Algorithms, Discrete Math, Linear Algebra} \\
